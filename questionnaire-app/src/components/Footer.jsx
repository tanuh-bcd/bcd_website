...
const Footer = () => {
  const socialLinks = [
    { icon: <Globe size={20} />, url: import.meta.env.VITE_WEBSITE_URL, label: 'Website' },
    { icon: <Linkedin size={20} />, url: import.meta.env.VITE_LINKEDIN_URL, label: 'LinkedIn' },
    { icon: <Twitter size={20} />, url: import.meta.env.VITE_TWITTER_URL, label: 'Twitter' },
    { icon: <Youtube size={20} />, url: import.meta.env.VITE_YOUTUBE_URL, label: 'YouTube' },
  ];
